...
//respostaConsultaNivellGrauDependencia/Resolucion/EstadoResolucion | Especifica l’estat de la resolució:<ul><li>Firmada</li></ul>
...
[form]:https://suport.aoc.cat/ca-ES/Formulari-de-suport-a-integradors/
